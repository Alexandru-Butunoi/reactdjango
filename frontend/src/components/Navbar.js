...
const navbar = ({ auth: {isAuthenticated, loading}, logout}) => {
    ...
    const guestLinks = (
        <Fragment>
            <NavLink className='navbar__top__auth__link' to="/login">Login</NavLink>
            <NavLink className='navbar__top__auth__link' to="/signup">Sign Up</NavLink>
        </Fragment> 
    );
            ...
            <nav className='navbar'>
                <div className='navbar__top'>
                    <div className='navbar__top__logo'>
                        <Link className='navbar__top__logo__link' to='/'>Realest Estate Logo </Link>
                    </div>
